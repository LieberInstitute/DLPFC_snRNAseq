...
initial[["ReducedDimensionPlot1"]] <- new("ReducedDimensionPlot", Type = "UMAP", XAxis = 1L, YAxis = 2L,
    ...
    ColorByColumnData = "cellType_hc", ColorByFeatureNameAssay = "logcounts",
...
initial[["ComplexHeatmapPlot1"]] <- new("ComplexHeatmapPlot", Assay = "logcounts", CustomRows = TRUE,
    ...
    DataBoxOpen = FALSE, VisualChoices = "Annotations", ColumnData = c("cellType_hc",
...
initial[["RowDataTable1"]] <- new("RowDataTable", Selected = "SNAP25", Search = "SNA", SearchColumns = c("",
...
initial[["FeatureAssayPlot1"]] <- new("FeatureAssayPlot", Assay = "logcounts", XAxis = "Column data",
    XAxisColumnData = "cellType_hc", XAxisFeatureName = "MIR1302-2HG",
    ...
    FacetColumnByColData = "SAMPLE_ID", ColorByColumnData = "cellType_hc",
